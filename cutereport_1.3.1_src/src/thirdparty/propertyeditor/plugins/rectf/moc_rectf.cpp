...
**
** Created: Sun Jan 22 16:06:48 2017
...
static const char qt_meta_stringdata_RectF[] = {
    "RectF\0qreal\0x\0y\0width\0height\0int\0"
    "_current_property\0_current_property_precision\0"
};
...
int RectF::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_id < 0)
     ...
     if (_c == QMetaObject::ReadProperty) {
        ...
        case 4: *reinterpret_cast< int*>(_v) = _currentProperty(); break;
        case 5: *reinterpret_cast< int*>(_v) = _current_property_precision(); break;
        }
        _id -= 6;
        ...
        case 4: _setCurrentProperty(*reinterpret_cast< int*>(_v)); break;
        }
        _id -= 6;
