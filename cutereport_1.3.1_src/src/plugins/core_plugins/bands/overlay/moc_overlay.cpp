...
**
** Created: Sun Jan 22 17:32:48 2017
...
const QMetaObject Overlay::staticMetaObject = {
    { &CuteReport::BandInterface::staticMetaObject, qt_meta_stringdata_Overlay,
...
void *Overlay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "CuteReport.BandInterface/1.0"))
        return static_cast< CuteReport::BandInterface*>(const_cast< Overlay*>(this));
