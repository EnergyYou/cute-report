...
**
** Created: Sun Jan 22 17:31:47 2017
...
const QMetaObject Script::staticMetaObject = {
    { &CuteReport::ScriptExtensionInterface::staticMetaObject, qt_meta_stringdata_Script,
...
void *Script::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "CuteReport.ScriptExtensionInterface/1.0"))
        return static_cast< CuteReport::ScriptExtensionInterface*>(const_cast< Script*>(this));
    typedef CuteReport::ScriptExtensionInterface QMocSuperClass;
