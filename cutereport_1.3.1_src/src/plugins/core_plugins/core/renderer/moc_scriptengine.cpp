...
**
** Created: Sun Jan 22 17:30:30 2017
...
const QMetaObject ScriptEngine::staticMetaObject = {
    { &CuteReport::ScriptEngineInterface::staticMetaObject, qt_meta_stringdata_ScriptEngine,
...
void *ScriptEngine::qt_metacast(const char *_clname)
{
    ...
    typedef CuteReport::ScriptEngineInterface QMocSuperClass;
