...
**
** Created: Sun Jan 22 17:33:16 2017
...
static const char qt_meta_stringdata_SyncManager[] = {
    "SyncManager\0"
};
...
const QMetaObjectExtraData SyncManager::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SyncManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SyncManager,
      qt_meta_data_SyncManager, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SyncManager::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SyncManager))
