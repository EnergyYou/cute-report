...
**
** Created: Wed Feb 8 11:34:02 2017
...
static const char qt_meta_stringdata_Console[] = {
    "Console\0\0url,success\0slotExportDone(QString,bool)\0"
    "slotPrintDone(QString,bool)\0"
    "slotPreviewClosed()\0"
};
...
void Console::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->slotExportDone((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 1: _t->slotPrintDone((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 2: _t->slotPreviewClosed(); break;
        default: ;
        }
    }
}
