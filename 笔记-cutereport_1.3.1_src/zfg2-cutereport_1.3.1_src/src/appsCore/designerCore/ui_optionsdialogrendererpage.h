/********************************************************************************
** Form generated from reading UI file 'optionsdialogrendererpage.ui'
**
...
#ifndef UI_OPTIONSDIALOGRENDERERPAGE_H
#define UI_OPTIONSDIALOGRENDERERPAGE_H
...
class Ui_OptionsDialogRendererPage
{
public:
    ...
    void setupUi(QWidget *OptionsDialogRendererPage)
    {
        if (OptionsDialogRendererPage->objectName().isEmpty())
            OptionsDialogRendererPage->setObjectName(QString::fromUtf8("OptionsDialogRendererPage"));
        OptionsDialogRendererPage->resize(716, 490);
        gridLayout = new QGridLayout(OptionsDialogRendererPage);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        widget_2 = new QWidget(OptionsDialogRendererPage);
        ...
        line = new QFrame(OptionsDialogRendererPage);
        ...
        widget = new QWidget(OptionsDialogRendererPage);
        ...
        retranslateUi(OptionsDialogRendererPage);

        QMetaObject::connectSlotsByName(OptionsDialogRendererPage);
    } // setupUi

    void retranslateUi(QWidget *OptionsDialogRendererPage)
    {
        OptionsDialogRendererPage->setWindowTitle(QApplication::translate("OptionsDialogRendererPage", "Form", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("OptionsDialogRendererPage", "Default renderer name:", 0, QApplication::UnicodeUTF8));
        label_10->setText(QApplication::translate("OptionsDialogRendererPage", "Selected renderer Type:", 0, QApplication::UnicodeUTF8));
        labelRendering_2->setText(QApplication::translate("OptionsDialogRendererPage", "Assigned renderers:", 0, QApplication::UnicodeUTF8));
        bDelete->setText(QApplication::translate("OptionsDialogRendererPage", "...", 0, QApplication::UnicodeUTF8));
        bResetDefault->setText(QString());
        bAdd->setText(QApplication::translate("OptionsDialogRendererPage", "...", 0, QApplication::UnicodeUTF8));
        bDefault->setText(QApplication::translate("OptionsDialogRendererPage", "...", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class OptionsDialogRendererPage: public Ui_OptionsDialogRendererPage {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_OPTIONSDIALOGRENDERERPAGE_H
